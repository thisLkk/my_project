...
<el-row>
  <el-col :span="24">
    <el-button-group>
      ...
      <el-button type="primary" v-if="groupManager_btn_edit" :disabled="currentId===-1 ? true : false" icon="el-icon-edit" @click="handlerEdit">编辑</el-button>
      <el-button type="primary" v-if="groupManager_btn_del" :disabled="currentId===-1 ? true : false" icon="el-icon-delete" @click="handleDelete">删除</el-button>
      <el-button type="primary" v-if="groupManager_btn_resourceManager" :disabled="currentId === -1 ?  true : false" @click="handlerAuthority">
        <svg-icon icon-class="quanxian1"></svg-icon>权限分配</el-button>
      <el-button type="primary" v-if="groupManager_btn_userManager" :disabled="currentId === -1 ? true : false" @click="handlerUser">
...
export default {
  ...
  created() {
    ...
    this.groupManager_btn_del = true;
  ...
  methods: {
    ...
    getNodeData(data) {
      ...
      //console.log('getNodeData: ' + this.currentId);
    },
    handlerEdit() {
      if (this.form.id) {
        this.formEdit = false;
