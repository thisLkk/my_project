...
<el-row>
  ...
  <el-col :span="8" style='margin-top:15px;'>
    ...
    <el-tree class="filter-tree" check-strictly :node-key="getTreeNodeKey" :data="treeData" show-checkbox  highlight-current :props="defaultProps" :filter-node-method="filterNode" ref="menuTree" @node-click="getNodeData" default-expand-all>
    </el-tree>
  </el-col>
...
export default {
  ...
  created() {
    this.getList()
    this.groupManager_menu = true
    this.groupManager_element = true
  },
  computed: {
    // ...mapGetters([
    //   'elements'
