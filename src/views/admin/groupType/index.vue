...
<div class="app-container calendar-list-container">
  <div class="filter-container">
    ...
    <el-button class="filter-item" v-if="groupTypeManager_btn_add" style="margin-left: 10px;" @click="handleCreate" type="primary" icon="el-icon-edit">添加</el-button>
  </div>
...
<span>
  ...
  <span>
        ...
        <el-table-column width="160px" align="center" label="最后更新主机"><template slot-scope="scope">
  <span>
    ...
    <el-table-column align="center" :label="$t('table.actions')" width="150" class-name="small-padding fixed-width">
      <template slot-scope="scope">
  <el-button v-if="groupTypeManager_btn_edit" size="mini" type="success" @click="handleUpdate(scope.row)">
    编辑
  </el-button>
  <el-button v-if="groupTypeManager_btn_del" size="mini" type="danger" @click="handleDelete(scope.row)">删除
  </el-button>
</template>
    </el-table-column>
  </el-table>
...
export default {
  ...
  created() {
    this.getList();
    this.groupTypeManager_btn_edit = true; // this.elements['groupTypeManager:btn_edit']
    this.groupTypeManager_btn_del = true; // this.elements['groupTypeManager:btn_del']
    this.groupTypeManager_btn_add = true; // this.elements['groupTypeManager:btn_add']
  },
  /*
  computed: {
    ...mapGetters([
