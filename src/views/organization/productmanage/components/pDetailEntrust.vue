<template>
  <el-dialog class="p-detail-entrust" title="产品详情" :visible.sync="showBox" width="960px" @close="doClose">
     ...
     {{detailResultData.PrdName}}
        ...
        <div class="activity_dialog clearfix yh-tabel-content">
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="发行范围:" prop="IsFullWebIssue">
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="300万以下已用名额:" prop="Bwy300NxUsedQuota">
                {{detailResultData.Bwy300NxUsedQuota}}
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item label="300万以下剩余名额:" prop="Bwy300NxSurplusQuota">
                {{detailResultData.Bwy300NxSurplusQuota}}
              </el-form-item>
            </el-col>
            <el-col :span="12">
