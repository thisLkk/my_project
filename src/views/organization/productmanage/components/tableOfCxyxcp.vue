  ...
  <div class="yh_tableOfCxyxcp">
    ...
    <div class="main_table">
      <el-table :data="tableData" class="yh_table_auto_f" stripe size="mini" max-height=800 style="width: 100%">
        ...
        <el-table-column label="申购开始日期" width="110" align="center">
          <template slot-scope="scope">
            <el-popover trigger="hover" placement="top">
              <p>{{ scope.row.PursEndDate | filterFormatTime }}</p>
              <div slot="reference" class="name-wrapper">
                <el-tag size="mini">{{ scope.row.PursBeginDate | filterFormatTime}}</el-tag>
              </div>
            </el-popover>
          </template>
        </el-table-column>
        <el-table-column label="申购结束日期" width="110" align="center">
          <template slot-scope="scope">
            <el-popover trigger="hover" placement="top">
              <p>{{ scope.row.PursEndDate | filterFormatTime }}</p>
              <div slot="reference" class="name-wrapper">
                <el-tag size="mini">{{ scope.row.PursEndDate | filterFormatTime }}</el-tag>
              </div>
            </el-popover>
          </template>
        </el-table-column>
        <el-table-column label="申购费率" width="" align="center">
          <template slot-scope="scope">
            <div slot="reference" class="name-wrapper">
              <el-tag size="mini">
                <a href="javascript:void(0)" @click="openDetail(scope.row)">
        ...
        <!-- <el-table-column label="折扣率" width="" align="center">
          <template slot-scope="scope">
            <el-popover trigger="hover" placement="top">
        ...
        <el-table-column label="证券方风险等级" width="" align="center">
          <template slot-scope="scope">
            <el-popover trigger="hover" placement="top">
              <p>{{scope.row.SecSideRiskGdes | productFilter(dictypeObj.EDW20799, scope.row.SecSideRiskGdes)}}</p>
              <div slot="reference" class="name-wrapper">
