<template>
  <el-dialog class="p-detail-special-account" title="产品详情" :visible.sync="showD" width="960px" @close="doClose">
    <div class="yh_product_detail_title">
     {{detailResultData.PrdName}}
        ...
        <div class="activity_dialog clearfix yh-tabel-content">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="发行下限(万):" prop="IssueBtmLmt">
                {{detailResultData.IssueBtmLmt}}
              </el-form-item>
            </el-col>
            <el-col :span="12">
