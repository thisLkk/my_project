<template>
  <el-dialog class="p-detail-privatelyly-offered-funds" title="产品详情" :visible.sync="showBox" width="960px" @close="doClose">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="销售起始日:" prop="CallBeginDate">
                {{detailResultData.PrdSts==1?detailResultData.CallBeginDate:detailResultData.PursBeginDate 
                 | filterFormatTime}}
              </el-form-item>
            </el-col>
            <el-col :span="12">
...
export default {
  name: "pDetailPrivatelylyOfferedFunds",
  props: {
    name: {
      type: String,
      default: ""
...
<style lang="scss" scoped>
  .p-detail-privatelyly-offered-funds{
    .yh-tabel-content{
      color: #606464;
      font-size: 12px; 
    }
