<template>
  <el-dialog class="p-detail-finance-products" title="产品详情" :visible.sync="showBox" width="960px" @close="doClose">
    <div class="yh_product_detail_title">
     {{detailResultData.PrdName}}
        ...
        <div class="activity_dialog clearfix yh-tabel-content">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="累计已售金额(万):" prop="AggrSoldAmt">
                {{detailResultData.AggrSoldAmt}}
              </el-form-item>
            </el-col>
            <el-col :span="12">
