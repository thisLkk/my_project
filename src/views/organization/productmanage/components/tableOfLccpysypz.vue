  ...
  <div class="yh_tableOfLccpysypz">
    ...
    <div class="main_table">
      <el-table :data="tableData" class="yh_table_auto_f" stripe size="mini" max-height=800 style="width: 100%">
        ...
        <el-table-column label="销售起始日" width="110" align="center">
          <template slot-scope="scope">
            <el-popover trigger="hover" placement="top">
        ...
        <el-table-column label="销售终止日" width="110" align="center">
          <template slot-scope="scope">
            <el-popover trigger="hover" placement="top">
        ...
        <el-table-column label="产品期限" width="" align="center">
          <template slot-scope="scope">
            <div slot="reference" class="name-wrapper">
        ...
        <el-table-column label="预期收益率" width="" align="center">
          <template slot-scope="scope">
            <div slot="reference" class="name-wrapper">
              <el-tag size="mini">{{ scope.row.ExpectPayoffRate }}</el-tag>
            </div>
          </template>
        </el-table-column>
        <el-table-column label="到期日期" width="" align="center">
          <template slot-scope="scope">
            <el-popover trigger="hover" placement="top">
        ...
        <el-table-column label="认购对象" width="" align="center">
          <template slot-scope="scope">
            <el-popover trigger="hover" placement="top">
              <p>{{ scope.row.SaleObj }}</p>
              <div slot="reference" class="name-wrapper">
                <el-tag size="mini">{{ scope.row.SaleObj }}</el-tag>
              </div>
            </el-popover>
          </template>
        </el-table-column>
        <el-table-column label="评价风险等级" width="" align="center">
          <template slot-scope="scope">
            <el-popover trigger="hover" placement="top">
              <p>{{scope.row.FundRiskGdes |  productFilter(dictypeObj.OSPCD0246, detailResultData.FundAppraiseRiskGdes)}}</p>
              <div slot="reference" class="name-wrapper">
                <el-tag size="mini">{{scope.row.FundRiskGdes | productFilter(dictypeObj.OSPCD0246, detailResultData.FundAppraiseRiskGdes)}}</el-tag>
              </div>
            </el-popover>
          </template>
        </el-table-column>
      <!--   <el-table-column label="客户风险承受能力" width="" align="center">
          <template slot-scope="scope">
            <el-popover trigger="hover" placement="top">
              <p>{{ scope.row.FundRiskGdes }}</p>
              <div slot="reference" class="name-wrapper">
                <el-tag size="mini">{{ scope.row.FundRiskGdes }}</el-tag>
              </div>
            </el-popover>
          </template>
        </el-table-column> -->
