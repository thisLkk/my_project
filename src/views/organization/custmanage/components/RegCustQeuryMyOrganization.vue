<template>
  <div class="yh_RegCustQeuryMyDepartment">
    <el-card class="box-card">
      <el-form  size="mini" :model="form_data" :rules="rules" label-width="115px" ref="ruleForm" label-position="right">
        <el-row>
          <el-col :span="24">
        ...
        <el-row>
          ...
          <el-col :span="10">
                ...
                <el-button size="mini" id="el_query" v-on:click="onButtonClick33(form_data)">查询7</el-button>
