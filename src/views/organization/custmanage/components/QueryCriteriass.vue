      ...
      <div id="querycriteria" v-show="showquerydiv">
        <el-row>
          <div class="yh-manage-fastsearch">
            <el-col :span="8">
              <el-form-item label="快速搜索1:" prop="customerType" class="combo-col">
            ...
            <el-col :span="6">
              <el-form-item label-width="90px" label="机构：" prop="manager">
          ...
          <el-col :span="24">
            <div class="yh-buttondiv">
              <div class="yh-buttons">
                <el-button id="el_query" size="mini" @click="query()">查询3</el-button>
    ...
    query() {
      ...
      if (this.advSearchTypeFlag == true) {
        ...
        var param = {
          ...
          orgNo: this.form_data.manager, //客户经理
