    ...
    <div class="project_main">
      ...
      <div class="content clearfix">
        <el-form ref="form_project" :model="form_project" label-width="190px" size="mini">
          <el-row>
            <el-col :span="8">
              <el-form-item label="公募基金管理开始日期:" prop="MGHBJJBS">
                <el-input :title="form_project.PublicFundsMngBeginDate" type="text" v-model="form_project.PublicFundsMngBeginDate" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8" :offset="2">
              <el-form-item label="性质:" prop="CYRQ">
                <el-input type="text" v-model="form_project.PublicFundsMngNature" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
              <el-form-item label="办公地址所在城市:" prop="JSSYPZ">
                <el-input type="text" v-model="form_project.WorkAddrLocusCity" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8" :offset="2">
              <el-form-item label="所属证监局:" prop="MGGZHGBZ">
                <el-input type="text" v-model="form_project.BelongsSecuReguBur" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
              <el-form-item label="是否是银行系:" prop="DQRQ">
                <el-input type="text" v-model="form_project.IsBank" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8"  :offset="2">
              <el-form-item label="联系部门:" prop="DRBZJ">
...
<script>
  ...
  export default {
    name: "ResearchCustomerFundOneOne",
    data() {
      return {
        ...
        getresearchcenterinfo(param)
          .then(response => {
            if (response.Meta.Code == "0000") {
              ...
              this.form_project.IsBank =="1" ? "是" : this.form_project.IsBank =="0" ? "否" :""
              //-----------------------------------------------机构名称IsBank
