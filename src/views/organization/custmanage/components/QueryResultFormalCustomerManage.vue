<template>
  ...
  <div class="yh-queryresult clearfix">
    <InstitutionFormalCustomerManage ref="InstitutionFormalCustomerManages" name="cus" :lists="list" @addformalcuslist="addformalcuslist" @CtcLabelManagerGroud="CtcLabelManagerGroud" @AddServices ="AddServices"></InstitutionFormalCustomerManage>
...
import { InstitutionFormalCustomerManage } from "./index.js";
export default {
  name: "QueryResultFormalCustomerManage",
  props: {
    list: {
      type: Array
    },
  ...
  components: {
    InstitutionFormalCustomerManage
  },
  data() {
    return {
      page: 10,
