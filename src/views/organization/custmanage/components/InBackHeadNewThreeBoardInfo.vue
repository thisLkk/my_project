        ...
        <div class="content clearfix">
          <el-form ref="form_project" :model="form_project" label-width="190px">
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="持续管理费(万):" prop="CXGLF">
                  <el-input type="text" v-model="form_project.ContinuedMngFee" disabled></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="审核结果:" prop="SHJGSHJG">
                  <el-input :title="form_project.BizDep" type="text" v-model="form_project.AuditResult" disabled></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="挂牌(完成)日期:" prop="QZHJS">
...
export default {
  name: "InBackHeadNewThreeBoardInfo",
  data() {
    return {
