        ...
        <el-form ref="form_project" :model="form_project" label-width="190px" size="mini">
          <el-row>
            ...
            <el-col :span="8" :offset="2">
              <el-form-item label="销售资格核准时间:" prop="CYRQ">
                <el-input type="text" v-model="form_project.SaleQlfcApproveTime" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
          ...
          <el-row>
            ...
            <el-col :span="8" :offset="2">
              <el-form-item label="电话:" prop="SMJJGLRDJBH">
                <el-input :title="form_project.Phone" type="text" v-model="form_project.Phone" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
...
<script>
  ...
  export default {
    name: "ResearchCustomerFundOneThree",
    data() {
      return {
