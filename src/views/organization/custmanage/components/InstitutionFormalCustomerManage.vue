  ...
  <div class="yh-archives clearfix">
    <div class="yh-archives-all">
      <div class="yh-archives-all-header">
        ...
        <a class="yh-register" href="javascript:void(0)" v-if="OrgIdNumber" @click="AddClick()">
    ...
    <div class="yh-addcustomergroup">
      <el-dialog title="客户分组新增" :visible.sync="addCustomerGroupDialog" width="600px">
        <div class="form_data_group">
          <el-form ref="form_data_group" :rules="groupRules" :show-message="showerroemessage" :model="form_data_group" label-width="100px">
            <el-row>
              <el-col :span="12">
    ...
    <div class="yh-addcustomer">
      <el-dialog title="客户新增" :visible.sync="addCustomerDialog" width="800px">
        <div>
          <el-form ref="form_data" :rules="addRules" :show-message="showerroemessage" :model="form_data" label-width="140px">
            <el-row>
              <el-col :span="10">
            ...
            <el-row>
              <el-col :span="10">
                <el-form-item label="归属机构:" prop="addFromOrgan">
                  <OrgChoose selectType="radio" dataInitType="userOrg" @onOrgSure="onOrgSure"></OrgChoose>
                </el-form-item>
                <span style="color: red;position: absolute;top: 6px;left: 66px;">*</span>
              </el-col>
             ...
             <el-row>
              <el-col  :span="10">
                <el-form-item label="上传需求报告:">
                  <fileUpload :relId="form_data.Uuid" listenName="twoFile" :addfileList="addfileList" @setId="setId"></fileUpload>
                </el-form-item>
              </el-col>
            </el-row>
...
export default {
  name: "InstitutionFormalCustomerManage",
  props: {
    lists: {
      type: Array,
      default: ""
  ...
  created() {
    ...
    this.form_data_servicerecord.PlanEndTime = formatDateTime(
      now,
      "yyyy-MM-dd HH:mm:ss"
    ); //--------------------计划结束
    this.form_data_servicerecord.ActualEndTime = formatDateTime(
      now,
      "yyyy-MM-dd HH:mm:ss"
    ); //------------------实际结束
  ...
  methods: {
    ...
    AddServices(index, name, isStrater) {
      this.addfileList = [];
      this.form_data_servicerecord.ActivityNo = "";
