<template>
  <div class="yh_RegCustQeuryMyDepartment">
    <el-card class="box-card">
      <el-form :label-position="labelPosition" :model="form_data" :rules="rules" label-width="115px" ref="ruleForm"  size="mini">
        <el-row>
          <el-col :span="24">
        ...
        <template v-if="ssIsShow">
          <div class="yh-jbxx-content">
            ...
            <el-row>
              ...
              <el-col :span="7">
                <el-form-item label="客户经理：" prop="var18">
                    <!-- <el-option :key="item.key" :label="item.key" :value="item.key" v-for="item in var18_items" /> -->
                    <inputButtonCE/>
                </el-form-item>
              </el-col>
            ...
            <el-row>
              ...
              <el-col :span="10">
                ...
                <el-button size="mini" id="el_query" v-on:click="onButtonClick9(form_data)">查询6</el-button>
                <el-button size="mini" id="el_reset" v-on:click="onButtonClick30()">重置</el-button>
                </div>
              </el-col>
            </el-row>
...
export default {
  ...
  methods: {
    onButtonClick30: function() {},
    //查询
    onButtonClick9(data) {
      // alert("doQuery");
      /*       doRequestPost(global_.rest_path + "/formalcus/getMyCusFormal", this.form_data1)
        .then(
          function(response) {
      ...
      axios
        .post(global_.rest_path + "/formalcus/getMyCusFormal", this.form_data1)
