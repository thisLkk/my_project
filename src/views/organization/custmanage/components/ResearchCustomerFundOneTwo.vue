    ...
    <div class="project_main">
      ...
      <div class="content clearfix">
        <el-form ref="form_project" :model="form_project" label-width="190px" size="mini">
          <el-row>
            <el-col :span="8">
              <el-form-item label="公募托管开始日期:" prop="CYRQ">
                <el-input type="text" v-model="form_project.CustodyBeginDate" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8"  :offset="2">
              <el-form-item label="托管资格批复日期:" prop="JSSYPZ">
                <el-input type="text" v-model="form_project.CustodyQlfcDate" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
              <el-form-item label="证监会基金托管人代码:" prop="MGHBJJBS">
                <el-input :title="form_project.CsrcFundTrusteeCode" type="text" v-model="form_project.CsrcFundTrusteeCode" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8"  :offset="2">
...
<script>
  ...
  export default {
    name: "ResearchCustomerFundOneTwo",
    data() {
      return {
